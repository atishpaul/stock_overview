...
//
//     final specificNewsModel = specificNewsModelFromJson(jsonString);

import 'dart:convert';

SpecificNewsModel specificNewsModelFromJson(String str) => SpecificNewsModel.fromJson(json.decode(str));

String specificNewsModelToJson(SpecificNewsModel data) => json.encode(data.toJson());
...
class SpecificNewsModel {
  ...
  factory SpecificNewsModel.fromJson(Map<String, dynamic> json) => SpecificNewsModel(
